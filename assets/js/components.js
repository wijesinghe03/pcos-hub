  ...
  <div class="nav-mobile-drawer" id="mobileDrawer">
    ...
    <div class="nav-actions" style="flex-direction:column;margin-top:16px;gap:10px">
      <div style="display:flex; justify-content:space-between; align-items:center; width:100%; margin-bottom:10px;">
        <span style="font-weight:600; color:var(--text-mid)" data-i18n="display_appearance">Appearance</span>
      ...
      <div class="container">
        <div class="footer-grid">
          ...
          <div class="footer-brand">
            ...
            <p class="footer-tagline" data-i18n="footer_about_desc">Sri Lanka's first dedicated digital platform for managing Polycystic Ovary Syndrome — empowering patients and healthcare providers with secure, connected care.</p>
          ...
          <!-- Resources -->
          <div class="footer-col">
            <h4 data-i18n="footer_resources_title">PCOS Resources</h4>
            <ul class="footer-links">
              <li><a href="blog.html" class="footer-link"><i class="arrow">›</i> <span data-i18n="res_understanding">Understanding PCOS</span></a></li>
              <li><a href="blog.html" class="footer-link"><i class="arrow">›</i> <span data-i18n="res_symptom_checker">Symptom Checker</span></a></li>
              <li><a href="blog.html" class="footer-link"><i class="arrow">›</i> <span data-i18n="res_diet">Diet &amp; Nutrition</span></a></li>
              <li><a href="blog.html" class="footer-link"><i class="arrow">›</i> <span data-i18n="res_exercise">Exercise Guide</span></a></li>
              <li><a href="blog.html" class="footer-link"><i class="arrow">›</i> <span data-i18n="res_mental">Mental Wellness</span></a></li>
              <li><a href="blog.html" class="footer-link"><i class="arrow">›</i> <span data-i18n="res_faqs">FAQs</span></a></li>
            </ul>
          </div>
          ...
          <div class="footer-col footer-newsletter">
            ...
            <form class="newsletter-form" onsubmit="return false">
              <input type="email" class="newsletter-input" placeholder="Your email address" data-i18n-placeholder="footer_email_placeholder">
              <button type="submit" class="newsletter-btn" data-i18n="footer_subscribe_btn">Subscribe</button>
            </form>
        ...
        <div class="footer-stats reveal">
          <div class="footer-stat">
            ...
            <span class="footer-stat-label" data-i18n="stat_patients_reg">Patients Registered</span>
          </div>
          <div class="footer-stat">
            <span class="footer-stat-num"><span data-count="20" data-suffix="">0</span></span>
            <span class="footer-stat-label" data-i18n="stat_partner_hosp">Partner Hospitals</span>
          </div>
          <div class="footer-stat">
            <span class="footer-stat-num"><span data-count="98" data-suffix="%">0%</span></span>
            <span class="footer-stat-label" data-i18n="stat_sat_rate_short">Patient Satisfaction</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="footer-bottom-inner">
          <p class="footer-copy">© 2025 <a href="index.html">PCOS Care Hub</a>. Built with ♥ for Sri Lankan Women's Health. <span data-i18n="footer_copyright">All rights reserved.</span></p>
